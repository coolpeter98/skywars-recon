...
- **Open / planned:**
  ...
  - **Domain services:** routing and session plumbing are present, while matchmaking, parties, persistence, purchases, inventory, combat, and private-session behavior remain intentionally empty extension points for the user (per §3.8 priority list).
